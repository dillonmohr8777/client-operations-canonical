...
Public design preview: the site source and approved artwork are included for review, but unreleased audio is intentionally excluded. Track audio can be added later when it is cleared for publication.

Live preview: https://immohrtal-website.netlify.app

The hero now opens on a Higgsfield **Earth Zoom** of Dillon, generated
from his color portrait so the orbit-to-street dive lands on him instead
of the stock woman in the preset preview. The 814 headshot, cover, and
logo stay in the rest of the page. Reduced-motion visitors get the
landing poster only.
