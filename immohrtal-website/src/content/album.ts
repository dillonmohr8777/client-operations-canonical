...
export const artist = {
  ...
  heroVideo: 'earth-zoom.mp4' as string | null, // Higgsfield Earth Zoom of Dillon
  heroPoster: 'earth-zoom-poster.jpg' as string | null,
...
// Audio is intentionally omitted from this public design preview. Add approved
// release-day previews here only when the artist clears them for publication.
