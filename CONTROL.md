...
Last reconciled: `2026-07-16T07:27:15.9821606+00:00`
Queue revision: `15`
Mode: `manual-pilot`
...
- `sys-20260716-0004` **Map every authorized client login to an exact Bitwarden entry locator** [blocked]. Complete the open Windows Credential Manager enrollment once, unlock the installed Bitwarden extension for the primary vault in persistent Chrome, map exact item GUIDs through the visible vault UI, and register exact bw://item/<guid> locators for each active client system.
...
- **credentialBridge:** `v1.1.2-security-review-go-signed-cli-integrity-pinned-atomic-job-object-contained-sanitized-exact-account-locked-bootstrap-absent-no-secret-output`
- **credentialVault:** `primary-bitwarden-cli-authenticated-locked-google-login-item-user-confirmed-saved-secure-bootstrap-absent-human-enrollment-open-exact-guid-mapping-pending`
