...
const port = Number(process.env.M360_QA_PORT || 63823);
const mime = {
...
async function main() {
  ...
  const required = ["/index.html", "/styles.css", "/script.js", "/assets/media/momentum-higgsfield-walkthrough.mp4", "/assets/media/momentum-higgsfield-walkthrough-m.mp4", "/assets/media/poster.jpg", "/assets/brand/momentum-360-logo.png", "/assets/fonts/Manrope-Variable.woff2", "/assets/fonts/Unbounded-Variable.woff2", "/assets/founders/mac-frederick.webp", "/assets/founders/sean-boyle.webp"];
  ...
  try {
    ...
    result.ctaHrefs = await (async () => {
      ...
      return desktop.evaluate(() => ({
        audit: document.querySelector("#release .button--primary")?.href,
        talk: document.querySelector("#release .button--text")?.href,
        contact: document.querySelector(".film-beat--final .button--text")?.href,
      }));
    })();
    const expectedCtaHrefs = {
      audit: "https://www.needmomentum.com/free-website-seo-audit/",
      talk: "https://www.momentumvirtualtours.com/contact/",
      contact: "https://www.momentumvirtualtours.com/contact/",
    };
    ...
    for (const [key, selector] of Object.entries({
      contact: ".film-beat--final .button--text",
      audit: "#release .button--primary",
      talk: "#release .button--text",
    })) {
