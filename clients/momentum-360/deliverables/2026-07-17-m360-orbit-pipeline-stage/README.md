...
Canonical live app: https://momentum-360-agents.netlify.app/

This workspace contains:

- `site/` — the redesigned static product and lead-generation page
- `netlify/functions/ask.mjs` — the specialist router and OpenAI Responses API function
...
The app has a safe starter-plan fallback when `OPENAI_API_KEY` is not configured.
