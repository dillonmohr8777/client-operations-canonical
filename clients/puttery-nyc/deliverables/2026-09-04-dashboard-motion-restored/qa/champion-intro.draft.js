...
(() => {
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    const video=document.createElement('video');video.muted=true;video.loop=true;video.playsInline=true;video.preload='metadata';video.setAttribute('aria-hidden','true');video.src=spec.src;if(spec.poster)video.poster=spec.poster;
