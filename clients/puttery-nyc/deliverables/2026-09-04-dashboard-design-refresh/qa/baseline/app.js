...
const platformDetails = [
  ...
  },
  {
    ...
    name: "Tock",
    state: "gated",
    stateLabel: "Vendor action pending",
    role: "Primary Puttery reservation source and the strongest immediate booking measurement path.",
    confirmed: "Business group 28086, Puttery NYC business 37824, business.id filtering, and Reservation Webhook eligibility are bound. The local receiver and relay pass 31 current tests.",
    unknown: "Production registration, the rotated credential route, one controlled payload, Data Exports access, GA4 settings, and exact campaign-field preservation.",
  ...
  },
  {
    ...
    state: "deferred",
    stateLabel: "Deferred",
    role: "Authoritative Puttery commerce source for orders, checks, payments, refunds, and revenue centers.",
    ...
    unknown: "Restaurant GUID, management group, RMS tier, permissions, webhook eligibility, exports, closeout time, and Toast Tables use. All of it stays unanswered while Toast is out of scope.",
    fallback: "None needed in Phase 1. The 2026-08-27 kickoff deferred Toast to a later walk-in evaluation, and Tock now exposes a walk-in webhook that covers part of what Toast was wanted for.",
  },
  {
    key: "Tripleseat",
    name: "Tripleseat",
  ...
  },
  {
    ...
    confirmed: "Resy confirmed a Guest Profile Ingest API and a real-time Guest Profile Webhook on this account, documented alongside the reservation products.",
  ...
  },
  {
    ...
    confirmed: "Tock's webhook setup offers reservations, walk-ins, and guest profile as separately selectable feeds.",
...
function renderQuestions() {
  ...
  container.querySelectorAll("[data-answer-note]").forEach((input) => {
    input.addEventListener("change", () => {
      ...
      saveAnswers();
      showFeedback("Evidence note saved in this browser.");
    });
  });
}
