> Current integration status supersedes this historical readiness report: see [September 8 completion and evidence](../2026-09-08-tock-integration/README.md). Reservation ingestion and exports are connected; attribution and booking-value validation remain pending.
