...
- `separate-monthly-pdfs/This-Week-With-BOK-August-2026.pdf`
- `separate-monthly-pdfs/This-Week-With-BOK-September-2026.pdf`
...
`separate-graphics/` contains 8 individual 1080x1350 PNG files, including each interview-prompts page as its own asset.
